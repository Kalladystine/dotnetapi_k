...
public class openiap
{
    ...
    public static async Task<openiap> QuickConnect(string apiurl = "")
    {
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
        if (apiurl == null || apiurl == "") apiurl = Environment.GetEnvironmentVariable("apiurl");
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
    ...
    {
        var any = Any.Pack(new AggregateRequest()
        {
            Collectionname = collectionname,
            Aggregates = Newtonsoft.Json.JsonConvert.SerializeObject(aggregates),
            Queryas = queryas
        },
    ...
    {
        var any = Any.Pack(new InsertOneRequest()
        {
            Collectionname = collectionname,
    ...
    {
        var any = Any.Pack(new InsertManyRequest()
        {
            Collectionname = collectionname,
    ...
    {
        var any = Any.Pack(new UpdateOneRequest()
        {
            Collectionname = collectionname,
            Item = Newtonsoft.Json.JsonConvert.SerializeObject(item)
        },
    ...
    {
        var any = Any.Pack(new InsertOrUpdateOneRequest()
        {
            Collectionname = collectionname,
            Item = Newtonsoft.Json.JsonConvert.SerializeObject(item),
            Uniqeness = uniqeness
    ...
    {
        var any = Any.Pack(new InsertOrUpdateManyRequest()
        {
            Collectionname = collectionname,
            Items = Newtonsoft.Json.JsonConvert.SerializeObject(items),
            Skipresults = skipresults,
    ...
    {
        var any = Any.Pack(new UpdateDocumentRequest()
        {
            Collectionname = collectionname,
            Query = Newtonsoft.Json.JsonConvert.SerializeObject(query),
            Document = Newtonsoft.Json.JsonConvert.SerializeObject(documment)
        },
    ...
    {
        var any = Any.Pack(new DeleteOneRequest()
        {
            Collectionname = collectionname,
            Id = id
        },
    ...
    {
        var any = Any.Pack(new DeleteManyRequest()
        {
            Collectionname = collectionname,
            Query = Newtonsoft.Json.JsonConvert.SerializeObject(query),
            Recursive = recursive
    ...
    public async Task<dynamic?> QueueMessage(string queuename, string exchangename, dynamic payload, bool striptoken = true, string correlationId = "", bool rpc = false)
    {
        ...
        var any = Any.Pack(new QueueMessageRequest()
        {
            Queuename = queuename,
    ...
    public async Task<Workitem> PushWorkitem(string wiq, dynamic payload, string[]? addfiles = null, Workitem? wi = null)
    {
        ...
        var pwir = new PushWorkitemRequest()
        {
            Wiq = wiq,
            FailedWiq = wi.FailedWiq,
            SuccessWiq = wi.SuccessWiq,
            Name = wi.Name,
            Nextrun = wi.Nextrun,
